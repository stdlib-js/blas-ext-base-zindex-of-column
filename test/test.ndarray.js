...
var zindexOfColumn = require( './../lib/ndarray.js' );
...
tape( 'the function returns the index of the first column matching a search vector (row-major)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, offsets)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, offsets)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, mixed strides)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, mixed strides)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, negative strides)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, negative strides)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, large strides)', function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, large strides)', function test( t ) {
	var data;
	var out;
