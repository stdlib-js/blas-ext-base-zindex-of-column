...
var zindexOfColumn = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
	'skip': ( zindexOfColumn instanceof Error )
};
...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof zindexOfColumn, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 12', opts, function test( t ) {
	t.strictEqual( zindexOfColumn.length, 12, 'returns expected value' );
	t.end();
});
...
tape( 'the function returns an invalid index when M is less than or equal to zero (row-major)', opts, function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = zindexOfColumn( 0, data.N, new Complex128Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex128Array( data.x ), data.strideX, data.offsetX, new Uint8Array( data.N ), 1, 0 );
...
tape( 'the function returns an invalid index when N is less than or equal to zero (row-major)', opts, function test( t ) {
	...
	data = ROW_MAJOR_DATA;
	out = zindexOfColumn( data.M, 0, new Complex128Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex128Array( data.x ), data.strideX, data.offsetX, new Uint8Array( data.N ), 1, 0 );
...
tape( 'the function returns the index of the first column matching a search vector (row-major)', opts, function test( t ) {
	var data;
	var out;

	data = ROW_MAJOR_DATA;
	out = zindexOfColumn( data.M, data.N, new Complex128Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Complex128Array( data.x ), data.strideX, data.offsetX, new Uint8Array( data.N ), 1, 0 );

	t.strictEqual( out, data.expected, 'returns expected value' );
	t.end();
});

tape( 'the function returns the index of the first column matching a search vector (column-major)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, offsets)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, offsets)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, mixed strides)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, mixed strides)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, negative strides)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, negative strides)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (row-major, large strides)', opts, function test( t ) {
	var data;
	var out;
...
tape( 'the function returns the index of the first column matching a search vector (column-major, large strides)', opts, function test( t ) {
	var data;
	var out;
