...
/**
* Interface describing `zindexOfColumn`.
*/
interface Routine {
	/**
	...
	* // returns 1
	*/
	( order: Layout, M: number, N: number, A: Complex128Array, LDA: number, x: Complex128Array, strideX: number, workspace: Uint8Array, strideW: number ): number;
	...
	* // returns 1
	*/
	ndarray( M: number, N: number, A: Complex128Array, strideA1: number, strideA2: number, offsetA: number, x: Complex128Array, strideX: number, offsetX: number, workspace: Uint8Array, strideW: number, offsetW: number ): number;
}
...
* // returns 1
*/
declare var zindexOfColumn: Routine;


// EXPORTS //

export = zindexOfColumn;
